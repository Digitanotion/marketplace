...
}elseif (isset($_GET['user_mob_id__'])){
    $pageUsrID__=$_GET['user_mob_id__'];
}
elseif (isset($_POST['user_mob_id__'])){
    $pageUsrID__=$_POST['user_mob_id__'];
}
...
if (isset($_GET['pointer'])) {
    ...
    if ($allChats['status'] == 1) {
        ...
        // echo "CURRENT USER: $pageUsrID__ | SENDER:  ";  
        // echo $chatsEach['mallMsgSenderID']."<br> RECIEVER: ";
        // echo $chatsEach['mallMsgReceiverID']."<br>";
    ?>
