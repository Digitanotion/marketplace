 ...
 ?>
                <div class="row ha-mpage-items__wrapper mb-3">
                    <div class="col-4 rounded-start ha-mpage-item__image" style="background-image: url('../handlers/uploads/thumbs/<?php echo $thumbImageName ?>');">
                        ...
                        ?>
                        <span class="ha-topright__comp dropdown ">
 ...
 if (isset($_GET['msgID'])){
    ...
    $pointer=$_GET['pointer'];?>
            ...
            <div class="mt-3 fs-md text-end d-flex <?php echo ($chatsEach['mallMsgSenderID']==$pageUsrID__)? "justify-content-end" :"justify-content-start" ;?>">
              ...
              <?php echo $chatsEach['mallMsgValue'];?>
                <p class="m-0 p-0 fs-md">
                  <?php echo date("d M, y. h:m",$chatsEach['mallMsgTime']); echo ($chatsEach['mallMsgSenderID']==$pageUsrID__)? "<i class='fa fa-check-double '></i> " :"" ;?>
                </p>
              </div>
            </div>
            <?php }else{
        ...
        if (isset($_GET['sendmsg'])){
            $sendMsgNow=$message_ob->sendMsgUsrToUsr($_GET['sender'],$_GET['msgID'],$_GET['receiver'],$_GET['msgContent'],"usr_to_usr",$_GET['msgID']);
