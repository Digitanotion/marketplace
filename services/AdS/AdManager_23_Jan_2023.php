...
class AdManager
{
	...
	*/
	...
	function recievePromoPayment($paymentFor, $cost, $customerEmail, $ad_custID, $name)
	{
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS, "default_locale=ja&email=". $customerEmail ."&metadata[test]=value&amount=".$cost."&currency=JPY&payment_data[external_order_num]=".$client_reference_id."&payment_data[name]=".$name."&return_url=https://gaijinmall.com/views/pay/index.php");
