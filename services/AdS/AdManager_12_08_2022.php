...
public function update_Ad($dataAll,$adID){
 ...
 /*    public function getCategChildByID($categID){
	...
	function recievePromoPayment($paymentFor, $customerEmail, $ad_custID){
		...
		$priceID="price_1LSfH7Dv8pLIRel52Cfdauf8";
		$rand_token=md5(rand(10000,10000000000000000));
		switch ($promoPlanChoosen[0]) {
			case 'business':
				# code...
				break;
		...
		\Stripe\Stripe::setApiKey('sk_test_51JuDniDv8pLIRel5lqSRP3hIRKx7IiMARiaZGOPpoWl0Yrfhsr9j9DaTwmSOE4oDUVt1pKq8HJBfhKACyEqMylCJ00EZPqTWLe');
		header('Content-Type: application/json');

		$YOUR_DOMAIN = 'http://localhost:8080/gaijinmall';
