    ...
    <div class="col-md-5 col-lg-5 col-5 text-end text-dark ha-fs_7 nav-container fw-bolder">
        ...
        if ($securityManager_ob->is_user_auth__()) { ?>
            <nav>
                ...
                <ul class="">
                    <li><a class="active ha-nav__item" href="saved.php" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="My Saved Ads"><i class="fa fa-bookmark mx-auto"></i></a></li>
