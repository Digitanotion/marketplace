            ...
            <?php
                ...
                if($files['status'] == 1){ ?>
                  ...
                  <div class='row justify-content-center'>                                    
                      <?php 
                        //fetch the file
                        $images = explode(",", $files["message"][0]["mallIDDocFile"]);
                        foreach ($images as $key => $value) { ?>
                          <div class='col-12 col-sm-6 col-md-3 mb-3'>
                            <div class="">
                              <img class="img-fluid img-respnsive" src="../../media_store/idFiles/uploads/<?php echo $value ?>" />  
                            </div>

                            <div class='text-center mt-2'>
                              <a href="../../media_store/idFiles/uploads/<?php  echo $value ?>" class='btn btn-info px-4'>View</a>
                            </div>
                          </div>
                          <!-- /.info-box -->
                        <?php } ?>
