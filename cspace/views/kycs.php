                  ...
                  $count = 0;
                    if ($allKycs['status']==1){
                        foreach ($allKycs['message'] as $id) {
                          ...
                          $docType = $id['mallIDDocType'];
                          $docNumber = $id['mallIDDocNum'];
                          ...
                          echo '<tr>
                                ...
                                <td>'.$userAccMsg.'</td>
                                <td>'.$kycStatMsg.'</td>
                                <td><a href="kyc.php?id='.$defaultCol.'">click to view</a></td>
                                <td> <a onclick="kycMessage('.$mallUsrID.')" class="text-danger mx-1" title="Reject kyc"><i class="fas fa-thumbs-down"></i></a>  <a onclick="approveKyc('.$userID.','.$userPhone.','.$kycID.')" class="text-success
                                 mx-1" title="Approve kyc"><i class="fas fa-thumbs-up"></i></a></td>
  ...
  function approveKyc(id,usrPhone,kycID){
      ...
      var formData = {
        ...
        if(data == 1){
          ...
          document.getElementById("resp").innerText = "Kyc approved successfully";
          // $('.toast').toast('show');
...
$.ajax({
  ...
  if(data == 1){
    ...
    document.getElementById("resp").innerText = "Kyc declined successfully";
    // $('.toast').toast('show');
