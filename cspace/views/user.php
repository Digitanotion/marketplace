        ...
        <?php 
              ...
              if($usr['status'] == 1){
                  ...
                  if(empty($image)){
                    ...
                    if($gender == "male"){
                      $src = "https://gaijinmall.com/assets/images/ma.jpg";
                    }else{
                      $src ="https://gaijinmall.com/assets/images/fm.jpg";
                    }
                  }else{
                    $src = "https://gaijinmall.com/media_store/usrPictures/optimized/".$image;
                  }
              }
                ...
                <div class="col-12 col-sm-6 col-md-3">
                  <a href="#" class="text-dark">
                    ...
                    <span class="info-box-icon bg-danger elevation-1"><i class="fas fa-ad"></i></span>
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text">Prenium Ads</span>
