    ...
    <div class="col-md-5 col-lg-5 col-5 text-end text-dark ha-fs_7 nav-container fw-bolder">
        ...
        if ($securityManager_ob->is_user_auth__()) { ?>
            <nav>
                ...
                <ul class="">
                    <li><a class="active ha-nav__item" href="saved" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="My Saved Ads"><i class="fa fa-suitcase mx-auto"></i></a></li>
                    <li><a href="messages" class="ha-nav__item" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="My Messages"><i class="fa fa-envelope mx-auto"></i></a></li>
                    <li><a href="notifications" class="ha-nav__item" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Notifications"><i class="fa fa-bell mx-auto"></i></a></li>
                    <li><a href="adverts" class="ha-nav__item" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="My Adverts"><i class="fa fa-bullhorn mx-auto"></i></a></li>
                    <li><a href="New_Ad" class="ha-nav__item" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="New Advert">SELL</a></li>
        ...
        <?php
            ...
            echo '<a href="Signin" class="text-dark">Sign in</a>  | <a href="Signup" class="text-dark">Create Account</a>';
        }
        ?>
