            ...
            <div class="col-md-8 col-lg-8 col-sm-12 p-0 shadow-sm bg-white rounded-3 p-0">
                ...
                <div class="ha-profile-url-data__body">
                    <div class="ha-none__display w-50 text-center m-5 mx-auto">
                        ...
                        <div class="fs-title-4 fw-bolder" id="adverts2">There is no feedback yet</div>
                        <div class="fs-md" id="adverts3">Copy the link and send them</div>
                        <button type="button" class="btn-md btn-secondary p-1 mt-3 w-75 buttns0 buttns01" onclick="myLnked()" id="copd0" >Copy my link</button>
                    </div>
                </div>
            </div>
