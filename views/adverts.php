                                    ...
                                    <div class="sell-promote-ad-select p-2 w-75 mb-2" style="border:2px solid rgba(13, 110, 253, 0.4);" >
                                        <div class="d-flex justify-content-between" id="box">
                                            ...
                                            <p class="fw-bold fs-5">
                                                <a href="promotion_list.php?promo_name=<?php echo $promoLists['mallAdPromoName'] ?>" target="_blank"><i class="fa fa-info-circle text-info info"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Details" id="info"></i>
                                                </a>
                                            </p>
                                        </div>
                                        <div class="d-flex">
...
const tooltipList = [...tooltipTriggerList].map(tooltipTriggerEl => new bootstrap.Tooltip(tooltipTriggerEl))
        ...
        <script type="text/javascript">
            $(".info").click(function(){
                $(".info").parent().parent().parent().parent().removeClass('border border-info border-3');
                $(this).parent().parent().parent().parent().addClass('border border-info border-3');
            })
        </script>
</body>
</html>