                                    ...
                                    <li class="">
                                        ...
                                        if ($childCategory['status'] == 1) { ?>
                                            <ul>
                                                ...
                                                ?>
                                                        <li>
                                                            <a href="category.php?adcategory=<?php echo $childCategName['message'][0]['mallCategID']; ?>">

                                                                <img src="assets/images/categoryicons/<?php echo $childCategName['message'][0]['mallCategIcon'] ?>" class="img-fluid" style="width: 10%;"> 

                                                                <?php echo $childCategName['message'][0]['mallCategName']; ?>
