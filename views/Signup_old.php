        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                <div class="signindetails">
                    ...
                    <form id="formSignup" action="" method="POST" class="top--space mb-3">
                        <div class="row">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="txt_New_firstname" required id="txt_New_firstname"
                                    class="form-control p-3 fs-md-1" placeholder="Enter yourfirst name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="txt_New_lastname">
                                    <h6>Last name</h6>
                                </label>
                                <input type="text" name="txt_New_lastname" id="txt_New_lastname"
                                    class="form-control p-3 fs-md-1" placeholder="Enter your last name">
                            </div>
                            <div class="form-group mb-3">
                                <label for="txt_New_email">
                                    <h6>Email address <span class="text-danger">*</span></h6>
                                </label>
                                <input type="email" required name="txt_New_email" id="txt_New_email"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" required name="txt_New_phone" id="txt_New_phone"
                                    class="form-control p-3 fs-md-1" placeholder="Enter your phone">
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="password" required name="txt_New_pwd" id="txt_New_pwd"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" required name="txt_New_verifypwd" id="txt_New_verifypwd"
                                    class="form-control p-3 fs-md-1" placeholder="************">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button type="submit" name="btn_New_user" id="btn_New_user"
                                    class="btn btn-primary btn-signindetails">Sign up</button>
                            </div>
                        </div>
                    ...
                    <!--Reset page link-->
                    <p class="p-tag top--space mb-3 fs-md-2"><b>By signing up you agree to our <a href="#"
                                class="text-primary">Terms and Conditions</a></b></p>
                    <p class="signup p-tag fs-md-1">Already have an account? <a href="Signin.php"
                            class="text-primary">Signin</a></p>
                </div>
