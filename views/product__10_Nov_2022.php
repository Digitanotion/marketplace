        ...
        <div class="card py-3 px-3 shadow-sm border-0 my-4">
          <div class="card-body py-2 m-0">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="ha-price_button_offer my-2">
                  <button <?php echo ($pageUsrID__ == "null") ? "" : 'data-bs-toggle="modal" data-bs-target="#sendDM"'; ?> class="ob-make-offer__btn btn btn-outline-primary w-100 fw-bolder sendDM" ><i class="fa fa-comments fs-5"></i>Send a DM</button>
                </div>
              </div>
            </div>
          </div>
