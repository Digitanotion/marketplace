                        ...
                        <div class="number_0" id="number0">
                            <form action="" method="POST">
                                <span class="d-flex justify-content-around ">
                                    <input type="email"  value="<?php echo $getUsrInfo['mallUsrEmail'];?>" name="edit_email__txt"  class="form-control">
                                    <button class="p-2 bg-light ms-2 rounded btn btn-primary text-primary fw-bold text-primary" name="edit_email__btn">Verify</button>
                                </span>
