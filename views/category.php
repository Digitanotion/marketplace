                        ...
                        <div class="my-3 px-2 bg-white ha-category-filter rounded" >
                          <div class="ps-2 pt-2 pb-2">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" name="mark-filter-keyword__input" class="form-control mark-filter-keyword__input fs-md p-2 mt-2" placeholder="Find Color">
                            </div>
          ...
          <div class="modal-content">
            ...
            <form>
                <div class="modal-body bg-light-blue">
                  <input type="text" name="mark-keyword__input" class="form-control mark-keyword__input fs-md p-3" placeholder="Find State">
