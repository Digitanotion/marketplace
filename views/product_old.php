                                ...
                                <div id="adImageCarousel" class="carousel slide " data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner" style="">
                                      ...
                                      <a class="ha-card-content-icon-1 d-flex justify-content-center align-items-center text-dark" href="#">
                                        <i class="fa fa-map-marker fw-bolder fs-6 mx-1 fa-bounce text-info"></i> <?php $adPosterLoc=explode(".",$allAdByID['mallAdLoc']); echo ucfirst($adPosterLoc[0]).", ".ucfirst($adPosterLoc[1]);?>, Japan
                                      </a>
                                    </div>
                ...
                <div class="col-md-3 p-0 my-md-0 my-lg-0">
                    ...
                    <div class="card-body py-2 m-0">
                      ...
                      <div class="form-group">
                        <div class="ha-price_button_offer my-2">
                          <button  class="ob-make-offer__btn btn btn-outline-primary w-100" <?php echo ($pageUsrID__=="null")?"disabled":"";?> data-bs-toggle="modal" data-bs-target="#makeOffer">Make an offer</button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card-body py-2 m-0">
                      <a href="#">
                        <div class="ha-seller__avatar__wrapper">
                          <div class="ha-seller__icon profile-image-init__avatar bg-purple" style="background-image: url('');"> 
                            <div class="ha-seller-status <?php echo ($getUsrInfo['mallUsrOnline']==1)? "bg-success" : "bg-grey";?>"></div> <!---->
                            <?php $initialLetter=$getUsrInfo['mallUsrFirstName']; echo $initialLetter[0];?>
                          </div> 
                          <div class="ha-seller__info">
                            <div class="ha-seller__name fs-title-1 ">
                              <?php echo $getUsrInfo['mallUsrFirstName']." ".$getUsrInfo['mallUsrLastName'] ; ?> 
                            </div> 
                      ...
                      <div class="form-group">
                          <div class="ha-price_button_offer my-2">
                            <button <?php echo ($pageUsrID__=="null")?"disabled":"";?> class="ob-make-offer__btn btn btn-outline-primary w-100 fw-bolder" data-bs-toggle="modal" data-bs-target="#sendDM"><i class="fa fa-comments fs-5"></i>Send a DM</button>
                          </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card py-3 px-3 shadow-sm border-0">
                    <div class="card-body py-2 m-0">
                      ...
                      <p>
                        <ul class="b-advert-safety-list"><li>
                      ...
                      <div class="form-group d-flex justify-content-center">
                        <div class="ha-price_button_offer my-2">
                          <button  class="ob-make-offer__btn btn btn-outline-danger btn-sm"><i class="fa fa-flag"></i>Report Ad</button>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      ?>                
                          <div class="row ha-sim-ad-pic__wrapper p-3">
                                                  <?php 
                                                    ...
                                                    ?>
                              <div class="col-4 bg-warning rounded-start ha-sim-ad-img__item" style="background-image: url('../handlers/uploads/thumbs/<?php echo $thumbImageName?>');">
                                <?php 
                                ...
                                <div class="">
                                  <a href="product.php?adID=<?php echo $value['mallAdID'];?>" class="text-dark">
                                      ...
                                      <div class="mt-2 py-auto">
                                        ...
                                        <span class="badge bg-info"><i class="fa fa-map-marker"></i> <?php $adPosterLoc=explode(".",$value['mallAdLoc']); echo ucfirst($adPosterLoc[0]).", ".ucfirst($adPosterLoc[1]); ?>, Japan</span>
                                      </div>
                                  </a>
                                </div>
                              </div>
