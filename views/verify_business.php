...
<body>
                ...
                <form class="row m-2 mt-4" action="" method="POST" enctype="multipart/form-data">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-start" id="info0">
                       ...
                       <!--  <select id="usrIDType__select" class="form-select mb-4" name="usrIDType__select">
                        ...
                        <span>
                            <input type="file" name="usrBizFile__file[]" id="usrBizFile__file" class="w-100 mb-5 form-control click_0" multiple onchange="preview()">
                        </span>
                        <!-- <span>
                        ...
                        <div class="col-md-6 imageDisplay mb-2" id="loadImageDisplay"></div>
                    </div> 
                    <div class="col-lg-12 col-md-12 col-sm-12 text-start" id="info1">
                       ...
                       <!--  <span class="d-flex">
                        ...
                        <span>
                            <input type="file" name="usrIDFile__file[]" id="usrIDFile__file" class="w-100 mb-5 form-control click_0" multiple="">
                        </span> -->
                        <span>
    ...
    <script type="text/javascript">
        function preview() {
            var totalFiles = $("#usrBizFile__file").get(0).files.length;
            for(var i = 0; i < totalFiles; i++) {
                $('#loadImageDisplay').append("<img class='w-25 rounded' style='margin-left:10px;' src = '"+URL.createObjectURL(event.target.files[i])+"'>");
            }
        }
    </script>
</body>
