...
.openOrderChild-card{
border:1px solid gray;margin:0px;border-radius:5px;padding:10px 20px;box-shadow:0px 0px 12px #ececec;
}
...
.openOrderChild{
border-radius:5px;width:100%;background-color:white;box-shadow:0px 0px 10px #d9d9d9;font-size:18px;margin-left:0px;padding:15px
}
.closeOrderChild{
...
.openOrderChild-card{
border:1px solid gray;margin:10px;margin-left:20px;margin-right:20px;border-radius:5px;padding:10px 50px;box-shadow:0px 0px 10px #ececec;
}
...
<body class="bg-light-blue">
    <?php include 'header-top.php'; ?>
      ...
      <section>
        ...
        <div>
            <div>
                <p class="checkout__customer-info" style="font-size:20px;font-weight:bold">
                   Items you ordered
                </p>
          ...
          >
            ...
            <div>
                <div class="d-flex flex-wrap justify-content-between align-items-start openOrderChild-card my-3">
                    <div>
                  <div>
                    <div class="d-flex flex-wrap align-items-start my-3">
                      ...
                      <div class="mx-sm-3 mx-xl-4">
                        ...
                        <div class="">
                          ...
                          <div>
                              <p style="margin-top: 10px;font-size:16px;font-weight:bold">Y7000</span>
                            </p>
                        </div>
                        <div class="mt-3">
