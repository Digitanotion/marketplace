...
if (isset($_SESSION['gaijinmall_user_'])){
        $logUsrID__ = $_SESSION['gaijinmall_user_'];
        $getLogUsrBizInfo = $usrAccManager_ob->getUsrBizInfoByID($logUsrID__)['message'];
}



$pageUsrID__ = "";
$pageLogUsrID__ = (isset($_SESSION['gaijinmall_user_'])) ? $_SESSION['gaijinmall_user_'] : "none";
$getUsrInfo = "";
$getUsrBizInfo = "";
$pageBizUsrID__="";
    ...
    if ($getUsrBizInfoSlug['status']==1){
       ...
       <script type="text/javascript">
           window.location.href = "https://gaijinmall.com/shop/";
       </script>
    <?php }
//Check if user is following the owner of this page
$isFollowing=$usrAccManager_ob->checkUserFollowingByID($pageLogUsrID__,$pageBizUsrID__)['status'];
$countFollowers=$usrAccManager_ob->countFollowersByID($pageBizUsrID__)['status'];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="Description" content="<?php echo $getUsrBizInfo['mallBizAbout']; ?>">
  <meta name="theme-color" content="#c3e6ff">
  <meta property="og:title" content="<?php echo $getUsrBizInfo['mallBizName']; ?>" />
  <meta property="og:description" content="<?php echo $getUsrBizInfo['mallBizAbout']; ?>" />
  <meta property="og:image" content="https://gaijinmall.com/assets/images/favicon.png">
            ...
            <nav>
                ...
                <ul class="">
                    ...
                    <li class="nav-item dropdown ha-dropdown__top">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="<?php echo $getLogUsrBizInfo['mallBizSlug'] ?>">My Page</a></li>
...
<div class="mt-4 mt-md-5 mt-lg-5 mb-5 mb-md-5 mb-lg-5">
    ...
    <div class="px-3 ha-profile__section mb-4">
        ...
        <div class="container ha-social__share mt-3 d-flex justify-content-center align-items-center">
            <span class="fw-bold">Share</span>
                  <a href="mailto:?subject=<?php echo $getUsrBizInfo['mallBizName'] ?>&body=Hello, Check this shop out <?php echo urlencode($currenturl); ?>. From gaijinmall.com" target="_blank" rel="nofollow" class="fa fa-envelope-o ms-2"></a>
                  <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode($currenturl); ?>&text=Hello friends, Check this shop out<?php echo $getUsrBizInfo['mallBizName']; ?>. From gaijinmall.com" target="_new" class="fa fa-facebook ms-2"></a>
                  <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode($currenturl); ?>&text=Hello friends, Check this shop out <?php echo $getUsrBizInfo['mallBizName']; ?>. From gaijinmall" target="_new" class="fa fa-twitter ms-2"></a>
                  <a href="whatsapp://send?text=Hey, Check this shop out <?php echo urlencode($currenturl . " From Gaijinmall"); ?>" target="_new" class="fa fa-whatsapp ms-2"></a>
                </div>
                <div class="mx-auto text-center mt-3 d-flex justify-content-center align-items-center">
                <span class="badge border border-secondary text-dark fs-md p-2" id="allVendorFollowers"><?php echo $countFollowers;?></span>
                <a href="#" class="btn-sm btn-primary" data-follow-status="<?php echo $isFollowing;?>" onclick="followVendor('<?php echo $pageLogUsrID__;?>','<?php echo $pageUsrID__;?>')" id="followVendor__btn"><?php echo ($isFollowing=="followed")? 'Unfollow <i class="fa fa-thumbs-down m-0"></i>':'Follow <i class="fa fa-thumbs-up m-0"></i>';?></a>
        </div>  
    </div>
                ...
                <div class="ha-profile-url-data__body mx-4 my-2">
                    ...
                    ?>
                                <div class="row ha-mpage-items__wrapper mb-3">
                                    <div class="col-4 rounded-start ha-mpage-item__image" onclick="shopToProduct('<?php echo $fields['mallAdID'];?>','<?php echo str_replace(' ','_',$fields['mallAdTitle']);?>')" style="background-image: url('../../handlers/uploads/thumbs/<?php echo $thumbImageName ?>');">
                                        <?php
