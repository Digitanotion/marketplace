...
<body>
    ...
    <section class="container-fluid m-0 p-0">
        <div class="row m-0 mx-sm-5 mx-md-5 mx-lg-5 mt-2 gx-0 gx-md-5 gx-lg-5 justify-content-between">
            ...
            <form method="POST" action="" id="form" class="col-md-8 col-lg-8 col-sm-12 p-0 shadow-sm bg-white rounded-3 p-0">
    ...
    <!-- rating. move to a seperate script -->
    <script type="text/javascript">
        $("input[name=rating_star]").change(function(event){

            var rating_num = $(this).val();
            var userID = $('input[name=user_id]').val();
            var adID = $('input[name=ad_id]').val();

            // $.post('./phpActions/rating.php', {rating_num, userID, adID})
            // .done(function(data){
            ...
            //         type: "success",
            //         message: "",
            //         title: "Product rated succefully",
            //         buttonText: "Ok",
            //     }).then(() => {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {rating_num : rating_num, userID: userID, adID: adID},
                cache: false,
