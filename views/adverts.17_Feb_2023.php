                                    ...
                                    <div class="sell-promote-ad-select p-2 w-75 mb-2" style="border:2px solid rgba(13, 110, 253, 0.4);">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <p class="fw-bold fs-5">
                                                <a href="promotion_list?promo_name=<?php echo $promoLists['mallAdPromoName'] ?>"><i class="fa fa-info-circle text-info"  data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="View Details" id="info"></i>
                                                </a>
                                            </p>
                                        </div>
                                        <div class="d-flex">
