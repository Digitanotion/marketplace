                ...
                <div class="ha-profile-url-data__body">
                    ...
                    <div class="text-dark" id="notifItems">
                       <div class="bg-light-blue m-1 mx-3">
                            <p class="w-md-75 w-lg-75 w-sm-100 px-3 pt-3"><?php echo $notificatioEach['mallNotifyContent']?></p>
                            <span class="d-flex lh-1 px-3 pb-2 opacity-50">
                                <p class="fs-md mb-2 p-0"><?php echo date("d M, Y", $notificatioEach['mallNotifyTime']);?></p>
