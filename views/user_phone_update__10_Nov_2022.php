            ...
            <div class="col-md-8 col-lg-8 col-sm-12 p-0 shadow-sm bg-white rounded-3 p-0">
                    ...
                    <div class="ha-none__display w-50 text-center m-5 mx-auto">
                        <div class="number_0" id="number0">
                            <form action="" method="POST">
                                <span class="d-flex justify-content-around w-75">
                                    <input type="text" id="disabledTextInput" value="<?php echo $getUsrInfo['mallUsrPhoneNo'];?>" name="edit_phone__txt" <?php echo ($isUsrIDUploaded['status'] == 1) ? "" : "disabled"; ?> class="form-control">
                                    <button class="p-2 text-dark bg-light ms-3 rounded" name="edit_phone__btn" <?php echo ($isUsrIDUploaded['status'] == 1) ? 'type="submit"' : 'type="button" onclick="myPhone()"'; ?>><i class="fa fa-pencil m-0 mx-1 fs-title-4"></i></button>
                                </span>
                                <span class="d-flex m-2">
                                    <?php if ($getUsrInfo['mallUsrPhoneNoStatus'] == 1) {
                        ...
                        ?>
                            ...
                            <div class="w-75 call_0" id="call0">
                                <span><input type="text" id="" placeholder="New phone number" class="form-control m-1 mb-3 btn btn-outline-primary bg-white"></span>
                ...
                <form class="row m-2 mt-4" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 text-start  info_0" id="info1">
                        ...
                        <span>
                            <input type="text" name="usrIDPhone__txt" id="usrIDPhone__txt" placeholder="New phone number*" class="form-control btn-outline-secondary bg-white p-2 mb-4 text-dark" onkeypress="myEnable()">
                        </span>
                        <span>
