            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <form method="POST" action="">
                  ...
                  <div class="ha-price_button_offer my-2">
                  <button type="button" name="sendChat__btn" class="ob-make-offer__btn btn-mobile btn-outline-primary-mobile w-100 fw-bolder sendD" onclick="window.flutter_inappwebview.callHandler('navi_sendMsg', 'navi_sendMsg', '<?php echo $adID; ?>','<?php echo $getUsrInfo['mallUsrID']; ?>')"><i class="fa fa-comments fs-5"></i>Send a Message</button>
                </div>
                </form>
          ...
          <div class="card-body py-2 m-0">
            ...
            <p>
              <span class="b-advert-safety-lis">
                ...
                N.B: You can block this seller if found abusive.
              </span>
            </p>
            <div class="form-group ">
              <div class="ha-price_button_offer my-2">
                <button class="ob-make-offer__btn btn-mobile btn-outline-danger-mobile w-100 reportAd__bt"  onclick="window.flutter_inappwebview.callHandler('navi_reportAd', 'navi_reportAd', '<?php echo $adID; ?>','<?php echo $getUsrInfo['mallUsrID']; ?>')"><i class="fa fa-flag"></i>Report Ad</button>
              </div>
            </div>
            <div class="form-group ">
              <div class="ha-price_button_offer my-2">
                <button class="ob-make-offer__btn btn-mobile btn-outline-danger-mobile w-100 reportAd__bt"  onclick="window.flutter_inappwebview.callHandler('navi_blockSeller', 'navi_blockSeller', '<?php echo $adID; ?>','<?php echo $getUsrInfo['mallUsrID']; ?>')"><i class="fa fa-ban"></i>Block this seller</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 mb-3">
            ...
            if ($getSimilarAds['status'] == 1 ) {
              echo '<h6 class="my-3">Similar Adverts</h6>';
              foreach ($getSimilarAds['message'] as  $value) {
                $getImageCount = $adManager_ob->countAdImagesByID($value['mallAdID']);
                if ($adID != $value['mallAdID']) {
                  //$childCategory=$adManager_ob->getCategChildByID($value['mallCategID']);
            ?>
                  <div class="row ha-sim-ad-pic__wrapper px-3 pb-3">
                    <?php
      ...
      if (isset($sys_msg) && !empty($sys_msg)) {
        switch ($sys_msg['msg_type']) {
          ...
          case '1':
            ...
            echo '
            window.addEventListener("flutterInAppWebViewPlatformReady", function(event) {
              window.flutter_inappwebview.callHandler("getPageAlert", "success", "Successful", "' . $sys_msg['msg'] . '")
          });
               '; /*  cuteAlert({
                type: "success",
          ...
          default:
            ...
            echo '
            window.addEventListener("flutterInAppWebViewPlatformReady", function(event) {
              window.flutter_inappwebview.callHandler("getPageAlert", "error", "Something went wrong", "' . $sys_msg['msg'] . '")
          });
            ';
            break;
        }
