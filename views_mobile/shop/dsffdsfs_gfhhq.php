...
<head>
    ...
    <meta name="keywords" content=" <?php
                    ...
                    ?>">
    <title><?php echo $getUsrBizInfo['mallBizName']; ?>'s Shop on Gaijinmall</title>
...
<div class="mt-4 mt-md-5 mt-lg-5 mb-5 mb-md-5 mb-lg-5">
    ...
    <div class="px-3 ha-profile__section mb-4">
        <div class="ha-image-profile__holder mx-auto bg-purple my-3"
            style="<?php $usrIcon=$getUsrInfo['mallUsrPhoto']; echo ($usrIcon=="" || $usrIcon=="NULL")?"":"background-image: url('./assets/images/testImages.png');";?>">
