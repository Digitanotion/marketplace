...
<body>
    <div class="container-fluid bg-white m-0  mx-auto">
        <div class="row m-0 mx-sm-5 mx-md-5 mx-lg-5 gx-0 gx-md-5 gx-lg-5">
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 " id="demo000">
                    <!-- Header text -->
                <!-- <div class="py-4 text-center fixed-top bg-white">
                    <div class="">
                        <h6 class="fs-title-5 fw-bolder p-0">BUSINESS INFORMATION</h6>
                    </div>
                ...
                <!-- <hr class="p-0 w-100 bg-hr-light"> -->

                <div class="ha-none__display w-100 text-center pt-4 under_fixed-elemen">
                    <form action="" method="post" class="">
                        ...
                        <div><button class="mt-2 mb-5 btn w-100" style="color: white; background-color: rgb(72, 72, 250);" id="demo1001" type="submit" name="editBizUpdate_settings">Save</button></div>
