      ...
      <div class="container">
        <div class="row my-3 ms-1">
          <div class="col-md-8">
            ...
            <?php
            $getSimilarAds = $adManager_ob->getSimilarAds($allAdByID['mallAdTitle'], $allAdByID['mallCategID'], $allAdByID['mallCategID'], $allAdByID['mallAdID']);
        ...
        switch ($sys_msg['msg_type']) {
          case '1':
            ...
            window.addEventListener("flutterInAppWebViewPlatformReady", function(event) {
                window.flutter_inappwebview.callHandler("getPageAlert", "success", "Operation Successful", "Your message has been sent.")
            });
            ';
            break;
          default:
            echo '
            window.addEventListener("flutterInAppWebViewPlatformReady", function(event) {
                window.flutter_inappwebview.callHandler("getPageAlert", "error", "Operation failed", "' . $sys_msg['msg'] . '")
            });';
            break;
        }
      }
